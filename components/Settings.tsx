...
export const Settings: React.FC<SettingsProps> = ({ config, onSave, onClose, isOpen }) => {
  ...
  const handleValueChange = (phase: Phase, valStr: string) => {
    ...
    setLocalConfig(prev => ({
      ...
      phases: {
        ...prev.phases,
        [phase]: {
          ...prev.phases[phase as Exclude<Phase, Phase.COMPLETE>],
          durationSeconds: val * multiplier
        }
      }
    }));
  };
      ...
      <div className={`w-full max-w-md ${bgColor} ${textColor} rounded-xl shadow-2xl border ${borderColor} overflow-hidden flex flex-col max-h-[90vh]`}>
        ...
        <div className="p-6 overflow-y-auto space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-bold opacity-50 uppercase">Phase Durations</h3>
            ...
            {[Phase.SETUP, Phase.PRESENTATION, Phase.Q_AND_A].map((phase) => {
               ...
               return (
                <div key={phase} className="flex items-center justify-between gap-4">
                  ...
                  <div className={`flex-1 flex items-center rounded border ${borderColor} ${inputBg} overflow-hidden`}>
                    <input
                      type="number"
                      min="0"
                      step="0.1"
                    ...
                    <div className="relative border-l border-inherit">
                      <select 
                        value={currentUnit}
